...
const Header: React.FC<any> = () => {
  const pomodoroIcon = (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_13320_152)">
        <path
  ...
  return (
    <div className="flex px-[80px] py-[15px] justify-between shadow-md">
      <div className="flex items-center">
        {pomodoroIcon}
        <p className="fw-300 text-customRed ml-[12px] text-[24px] leading-[24px]">pomodoro_box</p>
      </div>
      <button className="flex items-center  fw-300 text-customRed text-[16px] leading-[17px]">
        {stateIcon} Статистика
      </button>
    </div>
  );
};
